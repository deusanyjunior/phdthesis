...
%%FEULO achjo que não saquei bem essa utima frase, ficou confusa %dj OK
...
%%FEULO ..networks due the restrictions they impose. %dj OK
...
%%FEULO ...data transmission avoiding communication breakdown caused by full discharging. %dj OK
...
%% FEULO, é "always on" mesmo? always connected me soou melhor %dj YEP
...
%% FEULO prevalent, range and quality of mobile networks need to be increased constantly due the user's data traffic necessity %dj OK
...
%%FEulo USB interfaces that can also %dj OK
...
%% FEULO pra mim essa ultima frase não fez sentido =P %dj OK
...
%The mobile devices achieved their place 
%%FEULO não ei se "place" é a melhor palavra pra usar aqui, eu tentaria status ou algo similar
%with the size reduction of the components reaching nanometers nowadays.
%, that are billionths of a meter.
%%FEULO Vc repetiu "size reductions of components" duas vezes muito próximas, acho q tb não precisa falar que nanometro é um bilionesico de metro. %dj OK
...
Choosing the smartphone to buy can be life-changing experience
%%FEULO a life changer ou life changing, mas se a idéia é expor a complexidade da escolha eu usaria outra expressão %dj hmm..
...
%%FEULO Since their conception, Smartphones were/have been constantly updated and the impossibility of using the increasing number of features at a time... %dj hmm..
Power banks were developed in 2001, but they became a must-have accessory for smartphones only years later.
%%FEULO acho que born fica mto comercial, tenta were developed %dj OK
%% ...only years later. %dj OK
The batteries are also improving, but as the smartphones are replacing personal
%%FEULO avho que aqui caberia "taking places", substituting da ideia de algo temporário %dj hmm
...
%%FEULO ...another while connected to the internet %dj OK
...
%%FEULO atached to ou  atached at one device %dj OK
...
%%FEULO the same time if the first is over the second and share the same manufacturer Infrared standard. %dj ?!
...
%%FEULO ...another innterface that would connect to a third interface nd so on. %dj OK
...
%%FEULO eh short range aqii mesmo?? %dj hmm
...
%%FEULO fico meio repetitivo esse role d repetição %dj OK
