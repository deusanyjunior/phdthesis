...
First, a collaboration with \citefullauthor{bianchi2014processamento} resulted in an evaluation of realtime DSP on Android devices exploring the advantages of using JNI instead of pure Java~\citep{deCarvalhoJunior2013fftbenchmark}.
...
Six tests were conducted based on the number of floats sent as arguments inside the messages.
...
The experiments were done automatically by the PushLoop application and they were later analyzed.
